...
function DetailsProductSkeleton() {
  return (
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-1">
            {Array.from({ length: 5 }).map((_, i) => (
              <div
                key={i}
                className="h-4 w-4 bg-yellow-300 rounded-full animate-pulse"
              ></div>
            ))}
          ...
          <button className="w-full md:w-auto px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg animate-pulse">
